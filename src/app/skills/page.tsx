  ...
  return (
    <div id='skills'>
      ...
      <div className="md:grid md:grid-cols-3">
        ...
        <CardSkills title="Clean Code" description='Sigo as melhores práticas de clean code, mantendo meu código legível, organizado e de fácil entendimento, garantindo escalabilidade e facilitando o trabalho em equipe' imgs='/code.svg' />
      ...
      <div className="md:grid md:grid-cols-3">
        ...
        <CardSkills title="Clean Code" description='Sigo as melhores práticas de clean code, mantendo meu código legível, organizado e de fácil entendimento, garantindo escalabilidade e facilitando o trabalho em equipe' imgs='/cod-light.svg' />
        ...
        <CardSkills title="Bug fixer" description='Tenho experiência em identificar e corrigir bugs de forma eficiente, garantindo a estabilidade e desempenho do software. Minha abordagem proativa e detalhista permite resolver problemas rapidamente, minimizando o impacto no desenvolvimento' imgs='/bug-light.svg' />
